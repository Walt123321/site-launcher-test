...
$reviews_section_title = "$site_nameのレビュー";
...
$home_meta_description = "公式$site_nameウェブサイトは、高度な取引ツール、リアルタイムの市場インサイト、トレーダー向けの使いやすい体験を備えた安全な暗号資産取引プラットフォームを提供します。";
...
$hero_text = "公式$site_name暗号資産取引プラットフォーム";
...
$safe_title = "$site_nameで<mark>資金は安全です</mark>";
...
$trust_desc = "世界中で400万人以上のユーザーが、その信頼性、強力な自動化、透明な環境のために$site_nameを選択しています。";
...
$start_cta_desc = "$site_nameを試す準備はできましたか?今すぐ登録して、成長する暗号資産投資家やトレーダーのコミュニティに参加しましょう。";
$start_cta_btn = "登録";

// FAQ SECTION
$faq_title = "$site_nameよくある質問<mark>(FAQ)</mark>";
$faq_q1 = "$site_nameとは何ですか、どのように機能しますか?";
$faq_a1 = "これは、1日24時間あなたのために働くAI搭載の取引プラットフォームです。システムは市場を分析し、機会を見つけ、自動的に取引を実行します。AIにすべてを任せるか、手動モードに切り替えていつでも自分の条件で取引することができます。";

$faq_q2 = "$site_nameでの私のお金とデータはどのくらい安全ですか?";
...
$faq_a3 = "はい。$site_nameから資金をいつ、どのくらいの頻度で引き出すかに制限はありません。あなたの口座残高は常にあなたの完全な管理下にあります。出金は入金に使用されるのと同じ信頼できる決済プロバイダーを通じて処理され、迅速で安全な送金が保証されます。";

$faq_q4 = "隠れた手数料や追加料金はありますか?";
$faq_a4 = "ありません。$site_nameはサブスクリプション料金、登録料、隠れたコストを一切請求しません。開始に必要な唯一の金額は、あなたの取引口座に直接入金される<span data-local-currency='$app_price'>$app_price $app_currency</span>の最低入金額です。クレジットカード、銀行振込、PayPalを含むすべての主要な支払い方法が受け付けられます。";

$faq_q5 = "始めるために事前の取引経験は必要ですか?";
$faq_a5 = "まったく必要ありません。$site_nameは、まったくの初心者から経験豊富なトレーダーまで対応するように設計されています。完全自動モードでは、AIが市場分析、シグナル生成、注文執行など、すべてをあなたに代わって処理します。コントロールを維持したい場合は、いつでも手動モードに切り替えることができます。";
...
$features_title = "$site_name取引プラットフォームの<mark>主な機能</mark>";
...
$footer_disclaimer_p1 = "$site_nameは、金融市場、オンライン取引、デジタル資産に関する教育コンテンツと一般情報を提供します。このウェブサイトに掲載されているすべての資料(記事、チャート、価格データ、市場インサイト、分析を含む)は情報提供のみを目的としており、金融、投資、または法律上の助言と見なされるべきではありません。当社はコンテンツを正確かつ最新に保つよう努めていますが、その完全性や信頼性を保証するものではなく、このウェブサイトの使用に起因する損失について一切の責任を負いません。";
...
$about_meta_title = "会社概要 | $site_name公式サイト";
$about_meta_description = "$site_nameについて、AI自動化を通じて金融市場を民主化するという当社の使命、そして機関投資家レベルのセキュリティフレームワークについて詳しく学びましょう。";
$about_h1 = "<mark>$site_name</mark>について";
$about_lead = "人工知能、アルゴリズム執行、企業セキュリティを通じて、世界中のトレーダーに力を与えます。";
$about_mission_title = "私たちの使命";
$about_mission_text = "$site_nameでは、洗練された取引技術は機関投資家のファンドだけでなく、誰もが利用できるべきだと信じています。当社のプラットフォームは、日常の個人投資家と最先端の計算取引アルゴリズムの間のギャップを埋めます。";
...
$product_meta_description = "$site_nameを支える取引エンジンとAI機能をご覧ください。自動注文執行、予測分析、直感的なコントロール。";
...
$offer_meta_description = "$site_nameの限定登録オファーを発見してください。$app_price $app_currencyの初期入金で開始し、専任サポートを受けましょう。";
...
$offer_step2_text = "クレジットカード、銀行振込、または電子ウォレットを使用して、標準の最低額である$app_price $app_currencyを入金してください。あなたの資金の100%が直接あなたの取引残高に入ります。";
...
$contacts_meta_description = "$site_nameチームに連絡してください。24時間365日のカスタマーサポート、技術サポート、アカウントに関する問い合わせ。";
...
$faq_meta_description = "$site_nameアカウント、入金、出金、自動AI取引に関するよくある質問への回答を見つけてください。";
...
$privacy_meta_description = "$site_nameがあなたの個人データをどのように収集、保護、管理しているかを理解するために、当社の包括的なプライバシーポリシーをお読みください。";
$privacy_h1 = "プライバシーポリシー";
$privacy_p1 = "このプライバシーポリシーは、あなたが当社のウェブサイトを訪問したり、アカウントを登録したり、当社の取引ソフトウェアを利用したりする際に、$site_nameがどのように情報を収集、使用、開示するかを説明しています。";
...
$terms_meta_description = "$site_nameプラットフォームおよび関連サービスの使用を管理する公式利用規約をご確認ください。";
$terms_h1 = "利用規約";
$terms_p1 = "$site_nameにアクセスまたは使用する前に、これらの利用規約をよくお読みください。アカウントを登録することにより、これらの規定に拘束されることに同意したことになります。";
...
$terms_sec3_text = "$site_nameは情報提供およびソフトウェアルーティングサービスを提供します。当社は個別の金融アドバイスを提供せず、取引の収益性を保証しません。金融市場での取引には固有の資本リスクが伴います。";

// RISK WARNING PAGE VARIABLES (TZ Item 19: Exact 4 sections)
$risk_meta_title = "リスク警告と法的通知 | $site_name";
$risk_meta_description = "$site_nameでのCFD、Forex、暗号資産取引に関する重要なリスク開示。投資する前に注意深くお読みください。";
$risk_h1 = "リスク警告";
...
$risk_sec2_text = "$site_nameで提供されるすべての資料、ツール、アルゴリズムシグナル、コメントは、情報提供、教育、マーケティングの目的のみを意図しています。このウェブサイトのコンテンツは、個別の投資、法律、または金融アドバイスを構成するものではありません。取引を実行する前に、独立した調査を行うか、認可された金融アドバイザーに相談する必要があります。";
$risk_sec3_title = "3. 規制上および地理的制限";
$risk_sec3_text = "特定の管轄区域では、小売CFDおよび暗号資産取引が制限または禁止されています。$site_nameへのアクセスおよび提携取引ブローカーの利用が現地の法的枠組みの下で合法であるかどうかを確認することは、ユーザーの単独の責任です。";
...
$sign_meta_description = "インテリジェントな自動取引ツール、市場シグナル、安全な資金調達オプションにアクセスするために、$site_nameで無料アカウントを作成してください。";
...
$whatis_title = "$site_nameとは何ですか?";
$whatis_intro = "$site_nameは、日常のオンラインバンキングと同じくらい暗号資産をシンプルにするように設計された公式オンライン取引プラットフォームです。";
...
$whatis_icon_4_text = "わずか$app_price $app_currencyの最低入金額から始めましょう—隠れた手数料はありません。";
...
$benefits_title = "$site_nameの主なメリット";
...
$benefit_2_text = "$site_nameはライセンスを取得しており、適用される金融規制に準拠しています。当社はSSL暗号化と二要素認証を使用して、すべてのアカウントを保護しています。";
$benefit_3_title = "簡単なアクセス、障壁なし";
$benefit_3_text = "わずか$app_price $app_currencyの最低入金額で、誰でも始めることができます。大きな初期投資は必要ありません—小さく始めて、自信が高まるにつれて出資を増やしてください。";
...
$benefit_5_text = "昼夜を問わず、あなた自身のスケジュールで取引してください。$site_nameはデスクトップでもモバイルでも同様によく機能するため、どこにいても市場とつながっていられます。";
...
$benefits_trust_text = "だからこそ、多くの暗号資産ユーザーが$site_nameを信頼しています。何千人ものトレーダーがすでに$site_nameを使用しており、毎日新しいアカウントが参加しています。";
$benefits_cta = "登録";
...
$security_title = "$site_nameで資金は安全です";
...
$how_2_title = "資金を入金";
$how_2_text = "次に、アカウントに資金を追加します。最低入金額はわずか$app_price $app_currencyです。クレジット/デビットカード、現地の銀行振込、または人気の電子ウォレットを使用できます。(ヒント:快適に感じる金額から始めましょう。)";
$how_3_title = "取引を開始";
...
$trust_intro = "すでに$site_nameで取引している何千人ものユーザーに加わりましょう。当社のサイトには、現在何人の人が取引しているかを示すライブカウンターも表示されています。";
$trust_1_title = "完全に規制対象";
$trust_1_text = "$site_nameは正式に登録されており、適用される金融規制に準拠しています。当社は、あなたの安全を確保するために厳格な規則の下で運営しています。";
...
$pre_about_text = "今日$site_nameに参加して、明確さ、安全性、結果のために構築されたプラットフォームを発見してください。";
$pre_about_button = "登録";

// -- pretest (quiz teaser) badges/CTA --
$pretest_title = "$app_price $app_currencyで取引を始めましょう!";
$pretest_text = "$site_nameを試す準備はできましたか?今すぐ登録して、成長する暗号資産投資家やトレーダーのコミュニティに参加しましょう。";
$pretest_button = "登録";
$pretest_badge_1 = "安全";
...
// -- about page --
$about_label = "会社概要";
$about_title = "$site_nameについて";
$about_intro = "$site_nameは単に取引プラットフォームを提供するだけではありません—明確さと自信を持って取引できるようサポートします。";
$about_text_1 = "$site_nameは、初心者から経験豊富なトレーダーまで、暗号資産取引をアクセス可能にするように設計された公式オンライン取引プラットフォームです。";
...
$contact_title = "$site_nameに連絡する";
$contact_subtitle = "質問がありますか、それとも助けが必要ですか?私たちはあなたに助言し、案内するためにここにいます。";
$contact_text = "$site_nameでは、取引の成功は運とは何の関係もないと信じています—それは精度、予測、そして正しいツールに依存しています。";
...
// the root pages) --
$footer_disclaimer = "$site_nameは、金融市場、オンライン取引、デジタル資産に関する教育コンテンツと一般情報を提供します。このウェブサイトに掲載されているすべての資料は情報提供のみを目的としており、金融、投資、または法律上の助言と見なされるべきではありません。取引には重大なリスクが伴い、すべての投資家に適しているわけではありません。失っても構わない資金のみを投資してください。";
...
$analytics_heading = "$site_nameでよりスマートに取引";
...
// -- FAQ page --
$faq_page_meta_title = "よくある質問 | $site_nameサポート";
$faq_page_meta_description = "$site_nameの仕組み、価格設定、始め方に関するよくある質問への回答。";
...
$faq_1_a = "アカウントを作成し、メールアドレスを確認して、最初の入金をしてください—プランはわずか$app_price $app_currencyから始まります。";
$faq_2_q = "私のお金とデータは安全ですか?$site_nameは信頼できますか?";
...
$faq_4_a = "$site_nameは、より効率的に取引したいと考える、まったくの初心者から経験豊富なトレーダーまで対応するように構築されています—プラットフォーム上のすべてのツールは、あなたに情報を提供し、コントロールを維持できるように設計されています。";
...
$conditions_meta_description = "$site_nameのウェブサイトおよび取引プラットフォームの公式利用規約をお読みください。";
...
$page_description_risk_warning = "取引のリスクと、$site_nameがそれらを安全に管理するのにどのように役立つかを理解してください。";
