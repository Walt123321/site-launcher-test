...
- **template_7**: готові — de, es, fr, it, nl, pl, pt (вже були), + bg, da,
  el (додані цією сесією). Залишились: cs, fi, hr, hu, ja, ms, nb, no, ro,
  sk, sv, tr (+ мінімальний en-stub).
- **template_10**: не мав жодного перекладу окрім кореневого — потрібні всі
  22 мови (21 повний переклад + en-stub).
- **template_8, template_9**: вже повністю перекладені (усі 22 мовні файли
  на місці) — можна брати як додатковий референс формату.
